...
class InputProcessor {
  ...
  private:
    ...
    void process_animation_editor(int scancode);
  ...
  public:
    ...
    static constexpr auto reflect_members() {
        return std::make_tuple(
            ...
            Field<InputProcessor, std::unordered_map<std::string, TextureManager*>>{
                "texture_managers", &InputProcessor::texture_managers
            },
            ...
            Field<InputProcessor, std::unordered_map<std::string, Window*>>{
                "window_tools", &InputProcessor::window_tools
            },
