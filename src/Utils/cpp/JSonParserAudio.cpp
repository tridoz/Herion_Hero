...
auto JSONParser::audio::SetMasterVolume(int volume) -> void {
...
auto JSONParser::audio::IncreaseMasterVolume() -> void {
...
auto JSONParser::audio::DecreaseMasterVolume() -> void {
    std::ifstream audio_file_input(json_audio_file_path, std::ios::in);
    if (!audio_file_input.is_open()) {
        Logger::LogErr(
            std::time(nullptr),
...
auto JSONParser::audio::SetMusicVolume(int volume) -> void {
    std::ifstream audio_file_input(json_audio_file_path, std::ios::in);
    if (!audio_file_input.is_open()) {
        Logger::LogErr(
            std::time(nullptr),
...
auto JSONParser::audio::IncreaseMusicVolume() -> void {
    std::ifstream audio_file_input(json_audio_file_path, std::ios::in);
    if (!audio_file_input.is_open()) {
        Logger::LogErr(
            std::time(nullptr),
...
auto JSONParser::audio::DecreaseMusicVolume() -> void {
    std::ifstream audio_file_input(json_audio_file_path, std::ios::in);
    if (!audio_file_input.is_open()) {
        Logger::LogErr(
            std::time(nullptr),
...
auto JSONParser::audio::SetSFXVolume(int volume) -> void {
    std::ifstream audio_file_input(json_audio_file_path, std::ios::in);
    if (!audio_file_input.is_open()) {
        Logger::LogErr(
            std::time(nullptr),
...
auto JSONParser::audio::IncreaseSFXVolume() -> void {
    std::ifstream audio_file_input(json_audio_file_path, std::ios::in);
    if (!audio_file_input.is_open()) {
        Logger::LogErr(
            std::time(nullptr),
...
auto JSONParser::audio::DecreaseSFXVolume() -> void {
    std::ifstream audio_file_input(json_audio_file_path, std::ios::in);
    if (!audio_file_input.is_open()) {
        Logger::LogErr(
            std::time(nullptr),
...
auto JSONParser::audio::ToggleMute() -> void {
    std::ifstream audio_file_input(json_audio_file_path, std::ios::in);
    if (!audio_file_input.is_open()) {
        Logger::LogErr(
            std::time(nullptr),
...
auto JSONParser::audio::GetMasterVolume() -> float {
...
auto JSONParser::audio::GetMusicVolume() -> float {
    std::ifstream audio_file;
...
auto JSONParser::audio::GetSFXVolume() -> float {
    std::ifstream audio_file;
...
auto JSONParser::audio::Changed() -> bool {
    return changed;
}

auto JSONParser::audio::ChangesApplied() -> void {
    changed = false;
}
